...
const CARTEIRAS: Record<string, Carteira> = {
  conservador: {
    ...
    rendaFixa: 75,
    ativos: [
      { ticker: "PETR4", percentual: 8 },
      { ticker: "ITUB3", percentual: 7 },
      { ticker: "BBAS3", percentual: 5 },
      { ticker: "Tesouro Selic", percentual: 40 },
      { ticker: "CDB Banco AAA", percentual: 40 },
    ],
  },
  ...
  moderado: {
    ...
    rendaFixa: 40,
    ativos: [
      { ticker: "PETR4", percentual: 15 },
      { ticker: "ITUB3", percentual: 15 },
      { ticker: "BBAS3", percentual: 10 },
      { ticker: "SAPR11", percentual: 10 },
      { ticker: "Tesouro IPCA+", percentual: 25 },
      { ticker: "LCI", percentual: 25 },
    ],
  },
  ...
  arrojado: {
    ...
    ativos: [
      ...
      { ticker: "ITUB3", percentual: 15 },
      { ticker: "BBAS3", percentual: 15 },
      { ticker: "CMIG4", percentual: 15 },
      { ticker: "SAPR11", percentual: 10 },
      { ticker: "Tesouro Selic", percentual: 25 },
    ],
  },
};
