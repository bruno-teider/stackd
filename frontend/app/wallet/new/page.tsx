...
export default function NewTransactionPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    console.log({ mode, assetType, asset, date, quantity, price, otherCosts, total });
  ...
  <div className="bg-gray-100 shadow-lg rounded-xl p-6 ring-1 ring-gray-200">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/wallet" className="text-sm bg-gray-200 px-3 py-1 rounded-md hover:bg-gray-300">← Voltar</Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Outros custos <span className="text-xs text-gray-400">(Opcional)</span></label>
              <input
                type="number"
                min="0"
                step="0.01"
          ...
          <div className="flex items-center justify-between mt-4">
            <Link href="/wallet" className="text-sm bg-gray-200 px-3 py-1 rounded-md ring-1 ring-gray-200 hover:bg-gray-300">Cancelar</Link>
